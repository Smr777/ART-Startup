...
👉 **Beautiful Sections**: Includes hero, services, features, how to use, roadmap, pricing, footer, contact us form and header.
...
```bash
git clone https://github.com/Smr777/ART-Startup.git
cd ART-Startup
```
